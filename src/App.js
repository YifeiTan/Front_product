          ...
          <div className="container product">
              <div className="commodity-wrap">
                  <div className="comodity-pics">
                      <ul>
                          <li>
                              <img src="http://beta.asmodine.com/media/cache/product_thumb/uploads/products/4/6/5/1/8/7/large_702853_main.jpg" alt=""/>
                          </li>
                          <li>
                              <img src="" alt=""/>
                          </li>
                  ...
                  <div className="comodity-info">
                      ...
                      <div className="comodity-choose">
                          <div className="comodity-choose-left">
                              <div className="comodity-choose-circle">
                            <span>
                                <img src="" alt=""/>
                            </span>
                                  <span>
                          ...
                          <div className="comodity-choose-right">
                              <div className="comodity-select-title">
                                  <i className="fa fa-shopping-cart"/>
                                  Choisissez votre taille
                              </div>
                              <select className="comodity-select" name="" id="">
                      ...
                      <div className="comodity-introduce">
                          Description Tissu tissé Impression de chèque de vichy Revers de l'encoche Rabat-tempête Non-fonctionnement des poches latérales
                          Taille de la cravate Seul évent arrière Manches longues Notre modèle porte une taille anglaise 8 et mesure
                          175 cm de haut
                      </div>
                  </div>
              </div>
